...
public class ModItems {
    ...
    public static final Item WOULD_YOU_FALL_IN_LOVE_WITH_ME_AGAIN_MUSIC_DISC = registerItem("would_you_fall_in_love_with_me_again_music_disc",
            new Item(new Item.Settings().jukeboxPlayable(ModSounds.WOULD_YOU_FALL_IN_LOVE_WITH_ME_AGAIN_KEY).maxCount(1)));


    private static <T extends Item> T registerItem(String name, T item) {
        return Registry.register(Registries.ITEM, Identifier.of(DeathcordSMPMod.MOD_ID, name), item);
    }
